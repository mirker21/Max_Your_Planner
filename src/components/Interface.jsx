...
export default function Interface({
    ...
    function handleSoundsAndMusicAndVoiceOverChange(event) {
    ...
    return (
        <article id="interface">
            <button type="button" className="interface-button" id="sound-button" onClick={handleSoundsAndMusicAndVoiceOverChange}>
            ...
            <button type="button" className="interface-button" id="music-button" onClick={handleSoundsAndMusicAndVoiceOverChange}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
