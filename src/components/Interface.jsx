export default function Interface({
    ...
    return (
        <nav id="interface" role="navigation">
            ...
            <button aria-label="Open Review Today's Checklist Panel. Located inside of main, after navigation" type="button" className="interface-button" onClick={() => (setCurrentPanel('todays-todos'), setCurrentAnimation('Reading'))}>
                <svg aria-hidden xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <button aria-label="Open Search To-do s Panel. Located inside of main, after navigation" type="button" className="interface-button" onClick={() => (setCurrentPanel('search-todos'), setCurrentAnimation('Searching'))}>
                <svg aria-hidden xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <button aria-label="Open Add New To-do Panel. Located inside of main, after navigation" type="button" className="interface-button" onClick={() => (setCurrentPanel('add-new-todo'), setCurrentAnimation('Writing'))}>
                <svg aria-hidden xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
